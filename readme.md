...
## 🔗Project 10 Link
https://htmlcssproject10.netlify.app/
...
👉 Flexbox <br>
👉 How to set Background image compatible with screen size <br>
👉 Filter Property <br>
👉 **CSS Pseudo Selectors** <br>
👉 Position in CSS <br>
👉 SVG Images and how to seprate them <br>
👉 **RGBA color** setting <br>

## Time taken to complete this project was **4hr**.
